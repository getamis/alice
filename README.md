...
Let threshold = 3, and participants = 5. Assume that the corresponding rank of each shareholder are 0, 0, 1, 1, 2. Then authorized sets in this setting are 
1. 0, 0, 1
2. 0, 1, 1
3. 0, 1, 2

The other combinations of shares can not recover the secret (e.g. 1, 1, 2 or 1, 1, 1).
