...
const PaillierOperationAndPaillierCommitment = "AMIS-Alice-PaillierOperationAndPaillierCommitment-ZK-v1.0-"
...
func (msg *PaillierOperationAndCommitmentMessage) Verify(config *CurveConfig, ssidInfo []byte, n0, n1, C, D, X, Y *big.Int, ped *PederssenOpenParameter) error {
	...
	if err := utils.InRange(By, big0, n1Square); err != nil {
		return err
	}
	...
	if err := utils.InRange(E, big0, pedN); err != nil {
		return err
	}
	...
	if err := utils.InRange(F, big0, pedN); err != nil {
		return err
	}
	...
	if err := utils.InRange(Wy, big0, n1); err != nil {
		return err
	}
	...
	if err := utils.InRange(Bx, big0, n1Square); err != nil {
		return err
	}
	...
	if err := utils.InRange(Wx, big0, n1); err != nil {
		return err
	}
