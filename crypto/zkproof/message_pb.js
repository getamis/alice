...
goog.exportSymbol('proto.zkproof.ConsistencyTwoPointsMessage', null, global);
 ...
 * @constructor
 */
proto.zkproof.ConsistencyTwoPointsMessage = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.zkproof.ConsistencyTwoPointsMessage, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.zkproof.ConsistencyTwoPointsMessage.displayName = 'proto.zkproof.ConsistencyTwoPointsMessage';
}
 ...
 * @return {!Object}
 */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.toObject = function(opt_includeInstance) {
  return proto.zkproof.ConsistencyTwoPointsMessage.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.zkproof.ConsistencyTwoPointsMessage} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.zkproof.ConsistencyTwoPointsMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    salt: msg.getSalt_asB64(),
    u: msg.getU_asB64(),
    t: msg.getT_asB64(),
    a: (f = msg.getA()) && github_com_getamis_alice_crypto_ecpointgrouplaw_point_pb.EcPointMessage.toObject(includeInstance, f),
    b: (f = msg.getB()) && github_com_getamis_alice_crypto_ecpointgrouplaw_point_pb.EcPointMessage.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.zkproof.ConsistencyTwoPointsMessage}
 */
proto.zkproof.ConsistencyTwoPointsMessage.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.zkproof.ConsistencyTwoPointsMessage;
  return proto.zkproof.ConsistencyTwoPointsMessage.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.zkproof.ConsistencyTwoPointsMessage} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.zkproof.ConsistencyTwoPointsMessage}
 */
proto.zkproof.ConsistencyTwoPointsMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.zkproof.ConsistencyTwoPointsMessage.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.zkproof.ConsistencyTwoPointsMessage} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.zkproof.ConsistencyTwoPointsMessage.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSalt_asU8();
  if (f.length > 0) {
    writer.writeBytes(
 ...
 * @return {!(string|Uint8Array)}
 */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.getSalt = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 * @return {string}
 */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.getSalt_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getSalt()));
};
 ...
 * @return {!Uint8Array}
 */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.getSalt_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getSalt()));
};
...
/** @param {!(string|Uint8Array)} value */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.setSalt = function(value) {
  jspb.Message.setProto3BytesField(this, 1, value);
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.getU = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {string}
 */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.getU_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getU()));
};
 ...
 * @return {!Uint8Array}
 */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.getU_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getU()));
};
...
/** @param {!(string|Uint8Array)} value */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.setU = function(value) {
  jspb.Message.setProto3BytesField(this, 2, value);
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.getT = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {string}
 */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.getT_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getT()));
};
 ...
 * @return {!Uint8Array}
 */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.getT_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getT()));
};
...
/** @param {!(string|Uint8Array)} value */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.setT = function(value) {
  jspb.Message.setProto3BytesField(this, 3, value);
};


/**
 * optional ecpointgrouplaw.EcPointMessage A = 4;
 * @return {?proto.ecpointgrouplaw.EcPointMessage}
 */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.getA = function() {
  return /** @type{?proto.ecpointgrouplaw.EcPointMessage} */ (
    jspb.Message.getWrapperField(this, github_com_getamis_alice_crypto_ecpointgrouplaw_point_pb.EcPointMessage, 4));
};


/** @param {?proto.ecpointgrouplaw.EcPointMessage|undefined} value */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.setA = function(value) {
  jspb.Message.setWrapperField(this, 4, value);
};


proto.zkproof.ConsistencyTwoPointsMessage.prototype.clearA = function() {
  this.setA(undefined);
};
 ...
 * @return {!boolean}
 */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.hasA = function() {
  return jspb.Message.getField(this, 4) != null;
};


/**
 * optional ecpointgrouplaw.EcPointMessage B = 5;
 * @return {?proto.ecpointgrouplaw.EcPointMessage}
 */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.getB = function() {
  return /** @type{?proto.ecpointgrouplaw.EcPointMessage} */ (
    jspb.Message.getWrapperField(this, github_com_getamis_alice_crypto_ecpointgrouplaw_point_pb.EcPointMessage, 5));
};


/** @param {?proto.ecpointgrouplaw.EcPointMessage|undefined} value */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.setB = function(value) {
  jspb.Message.setWrapperField(this, 5, value);
};


proto.zkproof.ConsistencyTwoPointsMessage.prototype.clearB = function() {
  this.setB(undefined);
};
 ...
 * @return {!boolean}
 */
proto.zkproof.ConsistencyTwoPointsMessage.prototype.hasB = function() {
