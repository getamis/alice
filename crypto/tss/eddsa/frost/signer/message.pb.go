...
var file_github_com_getamis_alice_crypto_tss_eddsa_frost_signer_message_proto_rawDesc = string([]byte{
...
var (
	...
	file_github_com_getamis_alice_crypto_tss_eddsa_frost_signer_message_proto_rawDescData []byte
)
...
func file_github_com_getamis_alice_crypto_tss_eddsa_frost_signer_message_proto_rawDescGZIP() []byte {
	file_github_com_getamis_alice_crypto_tss_eddsa_frost_signer_message_proto_rawDescOnce.Do(func() {
		file_github_com_getamis_alice_crypto_tss_eddsa_frost_signer_message_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_getamis_alice_crypto_tss_eddsa_frost_signer_message_proto_rawDesc), len(file_github_com_getamis_alice_crypto_tss_eddsa_frost_signer_message_proto_rawDesc)))
	})
...
var file_github_com_getamis_alice_crypto_tss_eddsa_frost_signer_message_proto_goTypes = []any{
...
func file_github_com_getamis_alice_crypto_tss_eddsa_frost_signer_message_proto_init() {
	...
	file_github_com_getamis_alice_crypto_tss_eddsa_frost_signer_message_proto_msgTypes[0].OneofWrappers = []any{
		(*Message_Round1)(nil),
		(*Message_Round2)(nil),
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_getamis_alice_crypto_tss_eddsa_frost_signer_message_proto_rawDesc), len(file_github_com_getamis_alice_crypto_tss_eddsa_frost_signer_message_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
