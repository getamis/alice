...
type BodyRound1 struct {
	...
	SG *ecpointgrouplaw.EcPointMessage `protobuf:"bytes,3,opt,name=sG,proto3" json:"sG,omitempty"`
}
...
func (x *BodyRound1) GetSG() *ecpointgrouplaw.EcPointMessage {
	if x != nil {
		return x.SG
	}
	return nil
...
var file_github_com_getamis_alice_crypto_tss_eddsa_frost_signer_message_proto_rawDesc = []byte{
	...
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x01, 0x45, 0x12, 0x2f, 0x0a, 0x02, 0x73, 0x47,
