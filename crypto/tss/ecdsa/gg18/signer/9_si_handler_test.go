...
var _ = Describe("si handler, negative cases", func() {
	var (
		peerId = "peer-id"
	...
	BeforeEach(func() {
		...
		for _, s := range signers {
			p := tss.NewStopPeerManager[Type](Type_Si, s.ph.peerManager)
			s.ph.peerManager = p
		}
