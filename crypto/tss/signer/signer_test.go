...
func newSigners(curve elliptic.Curve, expPublic *pt.ECPoint, ss [][]*big.Int, msg []byte, funcs ...func(types.PeerManager) types.PeerManager) (map[string]*Signer, map[string]*mocks.StateChangedListener) {
	threshold := len(ss)
