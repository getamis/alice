...
func (x *Message) GetEncH() *BodyEncH {
	if x != nil {
		if x, ok := x.Body.(*Message_EncH); ok {
			return x.EncH
		}
	}
	return nil
...
func (x *Message) GetSh2Hash() *BodySh2Hash {
	if x != nil {
		if x, ok := x.Body.(*Message_Sh2Hash); ok {
			return x.Sh2Hash
		}
	}
	return nil
...
var file_github_com_getamis_alice_crypto_bip32_child_message_proto_rawDesc = string([]byte{
...
var (
	...
	file_github_com_getamis_alice_crypto_bip32_child_message_proto_rawDescData []byte
)
...
func file_github_com_getamis_alice_crypto_bip32_child_message_proto_rawDescGZIP() []byte {
	file_github_com_getamis_alice_crypto_bip32_child_message_proto_rawDescOnce.Do(func() {
		file_github_com_getamis_alice_crypto_bip32_child_message_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_getamis_alice_crypto_bip32_child_message_proto_rawDesc), len(file_github_com_getamis_alice_crypto_bip32_child_message_proto_rawDesc)))
	})
...
var file_github_com_getamis_alice_crypto_bip32_child_message_proto_goTypes = []any{
...
func file_github_com_getamis_alice_crypto_bip32_child_message_proto_init() {
	...
	file_github_com_getamis_alice_crypto_bip32_child_message_proto_msgTypes[0].OneofWrappers = []any{
		(*Message_Initial)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_getamis_alice_crypto_bip32_child_message_proto_rawDesc), len(file_github_com_getamis_alice_crypto_bip32_child_message_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
