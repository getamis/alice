...
func (x *Message) GetInitial() *BodyInitial {
	if x != nil {
		if x, ok := x.Body.(*Message_Initial); ok {
			return x.Initial
		}
	}
	return nil
...
func (x *Message) GetOtReceiver() *BodyOtReceiver {
	if x != nil {
		if x, ok := x.Body.(*Message_OtReceiver); ok {
			return x.OtReceiver
		}
	}
	return nil
...
func (x *Message) GetOtSendResponse() *BodyOtSendResponse {
	if x != nil {
		if x, ok := x.Body.(*Message_OtSendResponse); ok {
...
func (x *Message) GetCommitment() *BodyCommitment {
	if x != nil {
		if x, ok := x.Body.(*Message_Commitment); ok {
			return x.Commitment
		}
	}
	return nil
...
func (x *Message) GetDecommitment() *BodyDecommitment {
	if x != nil {
		if x, ok := x.Body.(*Message_Decommitment); ok {
...
var file_github_com_getamis_alice_crypto_bip32_master_message_proto_rawDesc = string([]byte{
...
var (
	...
	file_github_com_getamis_alice_crypto_bip32_master_message_proto_rawDescData []byte
)
...
func file_github_com_getamis_alice_crypto_bip32_master_message_proto_rawDescGZIP() []byte {
	file_github_com_getamis_alice_crypto_bip32_master_message_proto_rawDescOnce.Do(func() {
		file_github_com_getamis_alice_crypto_bip32_master_message_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_getamis_alice_crypto_bip32_master_message_proto_rawDesc), len(file_github_com_getamis_alice_crypto_bip32_master_message_proto_rawDesc)))
	})
...
var file_github_com_getamis_alice_crypto_bip32_master_message_proto_goTypes = []any{
...
func file_github_com_getamis_alice_crypto_bip32_master_message_proto_init() {
	...
	file_github_com_getamis_alice_crypto_bip32_master_message_proto_msgTypes[0].OneofWrappers = []any{
		(*Message_Initial)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_getamis_alice_crypto_bip32_master_message_proto_rawDesc), len(file_github_com_getamis_alice_crypto_bip32_master_message_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
