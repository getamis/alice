...
var file_github_com_getamis_alice_crypto_commitment_message_proto_rawDesc = string([]byte{
...
var (
	...
	file_github_com_getamis_alice_crypto_commitment_message_proto_rawDescData []byte
)
...
func file_github_com_getamis_alice_crypto_commitment_message_proto_rawDescGZIP() []byte {
	file_github_com_getamis_alice_crypto_commitment_message_proto_rawDescOnce.Do(func() {
		file_github_com_getamis_alice_crypto_commitment_message_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_getamis_alice_crypto_commitment_message_proto_rawDesc), len(file_github_com_getamis_alice_crypto_commitment_message_proto_rawDesc)))
	})
...
var file_github_com_getamis_alice_crypto_commitment_message_proto_goTypes = []any{
...
func file_github_com_getamis_alice_crypto_commitment_message_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_getamis_alice_crypto_commitment_message_proto_rawDesc), len(file_github_com_getamis_alice_crypto_commitment_message_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
